...
const binp = path.join(cargoDir, "bin", "rust-to-npm");

if (fs.existsSync(binp)) {
  console.log("Uninstalling rust-to-npm...");
  exec(`cargo uninstall rust-to-npm`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("rust-to-npm not found skipping!");
}
